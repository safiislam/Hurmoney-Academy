...
const MoreSection = () => {
    ...
    return (
        <div className="my-10">
            <p className={`text-4xl font-bold text-center my-20${darkMode ? 'text-white' : 'text-black'}`}>Frequently Asked Questions</p>
            <div>
                <div className={`collapse collapse-plus  ${darkMode ? 'bg-black text-white border' : 'bg-base-300 text-black'}`}>
